...
${ns} .message.reply .buttons button{
    ...
    background: #fff5;
    padding: 5px 10px;
    box-shadow:   -3px -3px 7px #fff8,3px 3px 7px rgba(55, 84, 170, 0.15),inset 0 0 15px rgba(55, 84, 170, 0), inset 0 0 20px rgba(255, 255, 255, 0), inset 0px 0px 4px rgba(255, 255, 255, 0.2) !important;
...
${ns} .message.reply .buttons button:hover{
    box-shadow: -3px -3px 7px #fff8, 0px 0px 4px rgba(255, 255, 255, 0.2),inset 3px 3px 7px rgba(55, 84, 170, 0.15), inset -3px -3px 10px #fff8 !important;
    color: #2d95fb87;
}
