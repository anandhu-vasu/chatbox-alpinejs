...
${ns} .message.reply .buttons button{
    ...
    background: #fff5;
    padding: 5px;
    box-shadow: inset 0 0 15px rgba(55, 84, 170, 0), inset 0 0 20px rgba(255, 255, 255, 0), 3px 3px 7px rgba(55, 84, 170, 0.15), -3px -3px 10px #fffa, inset 0px 0px 4px rgba(255, 255, 255, 0.2) !important;
    transition: all 0.5s;
}
${ns} .message.reply .buttons button:hover{
    box-shadow: inset 3px 3px 7px rgba(55, 84, 170, 0.15), inset -3px -3px 10px #fffa,-3px -3px 10px #fffa, 0px 0px 4px rgba(255, 255, 255, 0.2),3px 3px 7px rgba(55, 84, 170, 0.15) !important;
}
