                                ...
                                <div class="message reply">
                                    ...
                                    <template x-if="message.type=='image'">
                                        <div class="image">
                                            ...
                                            <img :src="message.content" width="200" class="scale-up-tl" onload="javascript: this.parentElement.className = 'image loaded'" onerror="javascript: this.parentElement.className = 'image error'"/>
                                            </label>
