...
${ns} .message.reply .buttons button{
    ...
    background: #fff5;
    padding: 5px 10px;
    box-shadow:   -3px -3px 10px #fff8,3px 3px 7px rgba(55, 84, 170, 0.15),inset 0 0 15px rgba(55, 84, 170, 0), inset 0 0 20px rgba(255, 255, 255, 0), inset 0px 0px 4px rgba(255, 255, 255, 0.2) !important;
    transition: all 0.25s ease-in-out;
    margin: 2.5px 2.5px;
}
${ns} .message.reply .buttons button span{
    transition: transform 0.1s ease,color 0.25s ease-in-out;
    display: inline-block;
    transform:scale(1,1);
}
...
${ns} .message.reply .buttons button:hover{
    box-shadow: -3px -3px 10px #fff8, 0px 0px 4px rgba(255, 255, 255, 0.2),inset 3px 3px 7px rgba(55, 84, 170, 0.15), inset -3px -3px 10px #fff8 !important;
    color: #2d95fb87;
}
...
${ns} .message.reply .buttons button:active span{
    transform:scale(0.8,0.8);
}
