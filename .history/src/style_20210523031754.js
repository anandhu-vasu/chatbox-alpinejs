...
${ns} .message.reply .buttons button{
    ...
    background: #fff5;
    padding: 5px 10px;
    box-shadow:   -1px -1px 5px #fff6,3px 3px 7px rgba(55, 84, 170, 0.15),inset 0 0 15px rgba(55, 84, 170, 0), inset 0 0 20px rgba(255, 255, 255, 0), inset 0px 0px 4px rgba(255, 255, 255, 0.2) !important;
...
${ns} .message.reply .buttons button:hover{
    box-shadow: -1px -1px 5px #fff6, 0px 0px 4px rgba(255, 255, 255, 0.2),inset 3px 3px 7px rgba(55, 84, 170, 0.15), inset -3px -3px 10px #fffa !important;
    color: #2d95fb87;
}
